...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (presupuestoMesSelector) {
        ...
        // Sincronizamos el cambio de mes para que afecte el resumen general y la tabla de movimientos
...
async function cargarDatosNube() {
    try {
        ...
        if (resPres.ok) {
            ...
            presupuestosMensuales = {}; // Reiniciamos el objeto de forma limpia
            
            dataPresupuestos.forEach(p => {
                if (!p.mes) return;
                // Normalizamos el mes asegurando extraer siempre el formato base YYYY-MM
