...
function actualizarTablaYResumen() {
    ...
    // ORDEN EXACTO: Primero por fecha del más reciente al más antiguo,
    // y si hay registros en la misma fecha, se ordenan por ID de mayor a menor (el último creado va arriba).
    ...
    movimientosVisibles.forEach(m => {
        ...
        // Formatear la fecha a estilo largo en español (ej. "lunes, 10 de agosto")
