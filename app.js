...
function sincronizarDatosGlobales() {
    ...
    // Si estás en la página de gráficos y existe la función, se ejecutará sin dar error en index.html
...
function obtenerMovimientosFiltrados() {
    ...
    return movimientos.filter(m => {
        ...
        // Si hay un rango de fechas especificado
        ...
        // Por defecto filtra por el mes seleccionado
